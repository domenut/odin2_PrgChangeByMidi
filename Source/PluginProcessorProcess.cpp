...
//    auto totalNumOutputChannels = getTotalNumOutputChannels();
    ...
    auto *inBuffer_l = buffer.getReadPointer(0);
//    auto *inBuffer_r = buffer.getReadPointer(1);
//    auto inBuffer = getBusBuffer(buffer, true, 0);
    ...
    // do input
       auto input_sample = inBuffer_l[sample];
//       auto input_sample_r = inBuffer_r[sample];
...
//                        m_osc_output[voice][osc] +=  input_sample;
                        m_osc_output[voice][osc] +=  m_voice[voice].audio_input_osc[osc].doAudioInput(input_sample);
                        break;
                    default:
                        break;
                    }
